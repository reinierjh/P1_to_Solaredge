...
remote_server_context.py  serial_forwarder.py  sync_updating_server.py  sync_updating_server.py_oldp1mon
pi@raspberrypi:~/code $ git init -b main
-bash: git: command not found
pi@raspberrypi:~/code $ ls -la
total 48
drwxr-xr-x  2 pi pi  4096 Jan 31 15:25 .
drwxr-xr-x 15 pi pi  4096 Feb 12  2019 ..
-rwx--x--x  1 pi pi  4077 Feb 12  2019 remote_server_context.py
-rwxr-xr-x  1 pi pi  1798 Feb 12  2019 serial_forwarder.py
-rwxr-xr-x  1 pi pi 12859 Jan 31 15:25 sync_updating_server.py
-rwxr-xr-x  1 pi pi 12842 Jan 31 14:51 sync_updating_server.py_oldp1mon
pi@raspberrypi:~/code $ more sync_updating_server.py
#!/usr/bin/env python
"""
Pymodbus Synchronous Server Example
--------------------------------------------------------------------------
